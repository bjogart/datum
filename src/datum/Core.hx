...
typedef BitSet = datum.sets.BitSet;
...
typedef FrozenDict<K, V> = datum.dicts.Dict.FrozenDict<K, V>;
typedef FrozenSet<T> = datum.sets.Set.FrozenSet<T>;
...
typedef Queue<T> = datum.buffers.Queue<T>;
typedef Set<T> = datum.sets.Set<T>;
typedef Stack<T> = datum.buffers.Stack<T>;
typedef TreeDict<K, V> = datum.dicts.TreeDict<K, V>;
